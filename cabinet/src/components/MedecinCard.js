  ...
  return (
    ...
    <div class="mx-10 grid place-content-center">
        <div class="bg-white py-8 px-10 text-center rounded-lg shadow-lg transform -translate-y-20 sm:-translate-y-24 max-w-xs mx-auto">
            ...
            <img class="w-20 h-20 object-cover rounded-full mx-auto shadow-lg" src={doctor.image_url} alt="User avatar"></img>
            <p class="capitalize text-xl mt-1">{doctor.speciality}</p>
            <span class="flex items-center border rounded-full w-36 pr-2 justify-center mx-auto mt-2 mb-2"><div class="bg-green-400 rounded-full w-2.5 h-2.5 block mr-2"></div>{doctor.tel}</span>
            ...
            <button class="rounded-lg bg-gradient-to-r bg-blue-400 text-lg text-white font-bold pt-2 pb-2 px-4 inline">Prendre RDV</button>
        </div>
    </div>
    </>
