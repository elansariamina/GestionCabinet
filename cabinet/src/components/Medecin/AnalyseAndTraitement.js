...
function AnalyseAndTraitement() {
  ...
  return (
    <>
      <div>
        <h1 className="text-xl font-bold mt-8 ml-12">Analyse</h1>
        ...
        <h1 className='text-xl font-bold mt-8 ml-12'>Traitement</h1>
        <div className='m-8 p-4 rounded-lg' style={{ boxShadow: '2px 2px 2px 2px rgba(0, 0, 0, 0.3)' }}>
        {rows.map((row, index) => (
